...
add wave -noupdate -itemcolor black /pipeline/escrevePC
add wave -noupdate -itemcolor black /pipeline/resultadoDaComparacaoBEQ
add wave -noupdate -itemcolor black /pipeline/srcPC
add wave -noupdate -itemcolor black /pipeline/fioIR
add wave -noupdate -itemcolor Black -radix decimal /pipeline/fioRS
add wave -noupdate -itemcolor Black -radix decimal /pipeline/fioRT
...
add wave -noupdate -itemcolor {Lime Green} /pipeline/storeExecMux
add wave -noupdate -itemcolor {Lime Green} /pipeline/storeMemMux
add wave -noupdate -itemcolor {Lime Green} -radix decimal /pipeline/dataToMemory
...
add wave -noupdate -radix decimal /pipeline/fioRSData
add wave -noupdate -radix decimal /pipeline/fioRTData
