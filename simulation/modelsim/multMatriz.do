...
add wave -noupdate -itemcolor black /pipeline/entrandoNoPipe
add wave -noupdate -itemcolor black -radix hexadecimal /pipeline/gambiarraPC
...
add wave -noupdate /pipeline/ID_EX_RS_DATA
add wave -noupdate /pipeline/ID_EX_RT_DATA
...
add wave -noupdate /pipeline/MEM_WB_readTam
...
add wave -noupdate /pipeline/resultadoBGEZ
...
add wave -noupdate /pipeline/addressToMemoryData
...
WaveRestoreCursors {{Cursor 1} {25400 ps} 0}
...
update
WaveRestoreZoom {25238 ps} {26205 ps}
