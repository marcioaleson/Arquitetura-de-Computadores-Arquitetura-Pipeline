...
add wave -noupdate -itemcolor Brown /pipeline/fioIR
...
add wave -noupdate -itemcolor {Green Yellow} -radix decimal /pipeline/MEM_WB_ReadData
...
add wave -noupdate -itemcolor {Midnight Blue} /pipeline/escreveIF_ID
add wave -noupdate -itemcolor {Midnight Blue} /pipeline/escrevePC
add wave -noupdate -itemcolor Black /pipeline/forwardHigh_Low
...
update
WaveRestoreZoom {201 ps} {1043 ps}
